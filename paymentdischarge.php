...
<table width="515" border="3">
    <thead>
        ...
        <!--<tr>
          <td>Razón de descuento</td>
          <td><textarea name="discountreason" id="discountreason"></textarea></td>
        </tr>-->
        <tr>
          <td colspan="2" align="center"><input type="submit" name="submitfullamount" id="submitfullamount" value="Registrar Pago" /></td>
        </tr>
      </tbody>
    </table> 
</form>    
...
<thead>
  <tr>
          <td colspan="2" align="center"><a href='patientreport.php?patientid=<?php echo $_GET[patientid]; ?>&appointmentid=<?php echo $_GET[appointmentid]; ?>'><strong>Ver reporte de paciente>></strong></a></td>
        </tr>
      </thead>
    </table>
    <p>&nbsp;</p>
