...
if(isset($_GET[delid]))
{
	...
	{
		echo "<script>alert('datos de facturaciòn eliminados exitosamente..');</script>";
	}
}
?>
 <section class="container">
<h2>Buscar Registro de Facturación - <input type="search" class="light-table-filter" data-table="order-table" placeholder="Filtro" /></h2>
...
?>
 	<table width="557" border="3">
      <tbody>
        ...
        <tr>
          <th width="124" scope="col"><div align="right">Número de Facturación &nbsp; </div></th>
		...
		<tr>
		  <th scope="col"><div align="right">Hora de Facturación &nbsp; </div></th>
	...
	<table class="order-table">
      <thead>
       <tr>
          ...
          <th width="86" scope="col">Monto</th>
        </tr>
        </thead>
        <tbody>
         <?php
...
if($rs[bill_type] == "Service Charge" || $rs[bill_type] == "Cargo por Prescripcion")
{
...
if($rs[bill_type]== "Room Rent" || $rs[bill_type]== "Habitacion")
{
		...
		echo " : ". $rsroomtariff[roomtype] .  "- Sala Nº." . $rsroomtariff[roomno];
}
...
if($rs[bill_type]  == "Prescription charge")
{
	...
	echo " </td><td>&nbsp;Bs. $rs[bill_amount]</td></tr>";
    ...
    <table width="557" border="3">
      <tbody>
        <tr>
          <th scope="col"><div align="right">Monto de Facturación &nbsp; </div></th>
          <td>&nbsp;Bs. <?php echo $billamt; ?></td>
        </tr>
        <tr>
          <th width="442" scope="col"><div align="right">Impuesto (2.91%) &nbsp; </div></th>
          	<td width="95">&nbsp;Bs. <?php echo $taxamt = 2.91 * ($billamt / 100); ?>
            </td>
        </tr>
		...
		<tr>
		  ...
		  <td>&nbsp;Bs. <?php echo ($billamt + $taxamt)  - $rsbilling_records[discount] ; ?></td>
	    </tr>
      </tbody>
    </table>
